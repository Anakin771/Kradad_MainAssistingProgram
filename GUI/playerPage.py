...
class PlayerPage:
    def __init__(self, root, frame, version):
        ...
        self.new_char = NewCharUI(self.root, self.new_char_frame, version=self.VERSION)
        ...
        self.level_up = CalculateLevelUI(self.root, self.level_up_frame, version=self.VERSION)
